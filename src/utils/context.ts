export const qa = [
  ...
  },
  {
    ...
    answer: `It's easy to use Google Flights to find deals on weekend getaways or even week-long trips.
...
export const destination = [
  ...
  {
    name: "Tallinn",
    position: { lat: 59.437, lng: 24.7535 },
  },
  {
    name: "Oslo",
  ...
  {
    name: "Vilnius",
    position: { lat: 54.6892, lng: 25.2798 },
  },
  {
    name: "Berlin",
